...
fetch('https://secret-mountain-68823.herokuapp.com//get-products/')
.then(res => res.json())
.then(data =>{
    products = data
    console.log(data)
...
fetch(`https://secret-mountain-68823.herokuapp.com/get-product/${id}/`)
.then(res => res.json())
.then(data =>{
    ...
    function update(){
        fetch(`https://secret-mountain-68823.herokuapp.com/edit-product/${idstored.getItem('product_id')}/`, {
            method: "PUT",
            body: JSON.stringify({
...
function convert(){
  ...
  function create(){
    ...
    fetch('https://secret-mountain-68823.herokuapp.com/products-create/', {
        method: "POST",
        body: JSON.stringify({
            'item_name': document.querySelector('#item_name').value,
            'description':  document.querySelector('#description').value,
