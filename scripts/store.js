...
function Deleteuser(){
    fetch(`https://stormy-anchorage-98868.herokuapp.com/show-user/${idStorage.getItem('username')}`,{
        method: "GET",
        body: JSON.stringify(),
        headers: {
...
fetch('https://stormy-anchorage-98868.herokuapp.com/get-products/')
.then(res => res.json())
.then(data =>{
    products = data
    console.log(data)
...
fetch(`https://stormy-anchorage-98868.herokuapp.com/show-user/${mystorage.getItem('username')}`,{
    method: "GET",
    body: JSON.stringify(),
    headers: {
        'Content-type': 'application/json',
...
function addClicked(id){
    fetch(`https://stormy-anchorage-98868.herokuapp.com/get-product/${id}/`, {
                method: "GET",
                body: JSON.stringify(),
                headers: {
                    'Content-type': 'application/json',
